...
add_action( 'woocommerce_product_options_general_prod<?php
/**
 * Adds a custom GST number field to the WooCommerce product general tab.
 */
function svntex_add_gst_field_to_products() {
...
add_action( 'woocommerce_process_product_meta', 'svntex_save_gst_field' );uct_data', 'svntex_add_gst_field_to_products' );
