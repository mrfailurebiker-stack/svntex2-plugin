<?php
/*
Plugin Name: SVNTeX Customer System
Description: Complete customer, wallet, KYC, employee, and reporting system for SVNTeX 2.0
Version: 2.0.0
Author: SVNTeX Team
*/

register_activation_hook(__FILE__, 'svntex2_customer_plugin_activate');
function svntex2_customer_plugin_activate() {
	global $wpdb;
